...
public class QOrder extends EntityPathBase<Order> {
    ...
    private static final long serialVersionUID = 1078242947L;
    ...
    public final EnumPath<family.project.domain.enums.OrderStatus> status = createEnum("status", family.project.domain.enums.OrderStatus.class);
